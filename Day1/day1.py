...
for i in range(len(data)): # loop through data
	c=int(data[i]) # current data will be data of index i
	if (i==0):p=c # if index==0, then previous data will become current
	if c>p:t+=1 # if current data > previous data, add one to total
	p=c # previous become current
print(t)
